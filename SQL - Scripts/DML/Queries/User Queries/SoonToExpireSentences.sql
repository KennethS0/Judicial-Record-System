...
Where ((@FromDate BETWEEN sentence.initial_date AND sentence.final_date) OR (@ToDate BETWEEN sentence.initial_date AND sentence.final_date)) AND
(@ToDate >= sentence.final_date)
