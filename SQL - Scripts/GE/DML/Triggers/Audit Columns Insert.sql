...
FOR EACH ROW
BEGIN
    :new.id := ge.country_sequence.NEXTVAL;
    :new.creation_user := USER;
    :new.creation_date := SYSDATE;
END;
/
...
FOR EACH ROW
BEGIN
    :new.id := ge.gender_sequence.NEXTVAL;
    :new.creation_user := USER;
    :new.creation_date := SYSDATE;
END;
/
...
FOR EACH ROW
BEGIN
    :new.id := ge.type_of_record_sequence.NEXTVAL;
    :new.creation_user := USER;
    :new.creation_date := SYSDATE;
END;
/
...
FOR EACH ROW
BEGIN
    :new.id := ge.type_of_sentence_sequence.NEXTVAL;
    :new.creation_user := USER;
    :new.creation_date := SYSDATE;
END;
/
...
CREATE OR REPLACE TRIGGER type_of_crime_inserted
BEFORE INSERT
ON type_of_crime
FOR EACH ROW
BEGIN
    :new.id := ge.type_of_crime_sequence.NEXTVAL;
    :new.creation_user := USER;
    :new.creation_date := SYSDATE;
END;
/
